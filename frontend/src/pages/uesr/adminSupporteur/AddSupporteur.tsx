...
const AddSupporteur = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (!fname && !lname && !telephone && ! adresse && !ville && !email && !password && !role) {
            ...
            await addSupporteurAdmin({...formValue, profil: data?.url, role: "supporteur"});
            toast.success("Supporteur a été ajouter avec succes");
        }
    };
  ...
  return (
    <>
        ...
        <div>
            <Typography variant='h5' sx={{fontWeight: "700", fontSize: "1.8rem"}}>Ajouter supporteur</Typography>
